...
public class SimpleColumnarTransposition {
    ...
    public static void enc(DataInputStream dis) throws Exception {
        while (true) {
            ...
            if (choice == 0) {
                System.out.println("********************************");
                System.out.println();
                System.out.println("Encryption results in the ciphertext: " + s1);
                System.out.println();
                //System.exit(0);
                return;
            }
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.print("Enter Plain text:"); // e.g. comehometomorrow
            s1 = dis.readLine();
            ...
            System.out.print("Enter no of rows: "); // e.g. 6
            m = Integer.parseInt(dis.readLine());
            System.out.print("Enter no of columns: "); // e.g. 3
